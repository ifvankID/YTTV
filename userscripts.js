...
(function () {
  ...
  function addMenuButton() {
    ...
    menuButton.textContent = 'YouTubeTV Mod By Fandy';
...
(function () {
  ...
  document.querySelectorAll('[id^=tt-settings]').forEach(el => el.remove());
      ...
      showModal('YouTubeTv Settings', buttons, parameters && parameters.length > 0 ? parameters[0] : 0, 'tt-settings', update);
  }
  ...
  function optionShow(parameters, update) {
      ...
      showModal('YouTubeTv Settings', buttons, parameters.selectedIndex, 'tt-settings-options', update);
  }
